...
import rawDbData from "./data/raw-db.json";
import playerHealthData from "./data/player-health.json";
...
// Board order + values come from src/data (regenerated by `npm run refresh-board`)
const RAW_DB = rawDbData.players;
...
// Merged Sleeper baseline + scripts/player-health-overrides.json (overrides win)
const PLAYER_HEALTH = Object.fromEntries(
  Object.entries(playerHealthData.players || {}).map(([name, h]) => [norm(name), h]),
);
